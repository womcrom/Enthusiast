...
local Enthusiast do
    ...
    Enthusiast = {
        ...
        Folders = {
            Directory = "Enthusiast",
            Configs = "Enthusiast/Configs",
            Assets = "Enthusiast/Assets",
            Themes = "Enthusiast/Themes"
        },

        Images = { -- you're welcome to reupload the images and replace it with your own links
            ["Saturation"] = {"Saturation.png", "https://github.com/womcrom/Images/blob/main/saturation.png?raw=true" },
            ["Value"] = { "Value.png", "https://github.com/womcrom/Images/blob/main/value.png?raw=true" },
            ["Hue"] = { "Hue.png", "https://github.com/womcrom/Images/blob/main/horizontalhue.png?raw=true" },
            ["Checkers"] = { "Checkers.png", "https://github.com/womcrom/Images/blob/main/checkers.png?raw=true" },
        },
